    ...
    <div className={styles.About} id="about">
      <div className="siteWidth sectionPadding siteSidePadding invisibleSideScrolling">
        ...
        <p>
          ...
          and got some good experience working with
          <b>React.</b>
          ...
          out. This website is built with
          <b>Svelte.</b>
        </p>
        <p>
          ...
          important is a<b>scalable system</b>
          (both in terms of code and design) that can grow in chunks, for a
